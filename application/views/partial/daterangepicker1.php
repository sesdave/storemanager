<?php $this->lang->load("calendar"); $this->lang->load("date"); 
	...
	{
?>
		$('#daterangepicker1').css("width","180");
		var start_date = "<?php echo date('Y-m-d') ?>";
		var end_date   = "<?php echo date('Y-m-d') ?>";

		$('#daterangepicker1').daterangepicker({
			"ranges": {
				"<?php echo $this->lang->line("datepicker_next_180"); ?>": [
					"<?php echo date($this->config->item('dateformat'), mktime(0,0,0,date("m"),date("d")+1,date("Y"))-1);?>",
					"<?php echo date($this->config->item('dateformat'), mktime(0,0,0,date("m"),date("d")+179,date("Y")));?>"
				],
				"<?php echo $this->lang->line("datepicker_next_90"); ?>": [
					"<?php echo date($this->config->item('dateformat'), mktime(0,0,0,date("m"),date("d")+1,date("Y"))-1);?>",
					"<?php echo date($this->config->item('dateformat'), mktime(0,0,0,date("m"),date("d")+89,date("Y")));?>"
				],
				"<?php echo $this->lang->line("datepicker_next_30"); ?>": [
				...
				"<?php echo $this->lang->line("datepicker_next_7"); ?>": [
					"<?php echo date($this->config->item('dateformat'), mktime(0,0,0,date("m"),date("d")+1,date("Y"))-1);?>",
			...
			"maxDate": "<?php echo date($this->config->item('dateformat'), mktime(0,0,0,01,01,2030));?>"
...
<?php
	...
	{
?>
		$('#daterangepicker1').css("width","305");
		...
		$('#daterangepicker1').daterangepicker({
			...
			"maxDate": "<?php echo date($this->config->item('dateformat')." ".$this->config->item('timeformat'),mktime(0,0,0,01,01,2030));?>"
		}, function(start, end, label) {
