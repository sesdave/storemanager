								...
								<table class="sales_table_100">
									...
									<tr>
										...
										<td>
											...
											<?php echo form_input(array('name'=>'card_tendered', 'id'=>'card_tendered', 'class'=>'form-control input-sm card-input', 'disabled' => true, 'value'=>'', 'size'=>'5', 'tabindex'=>++$tabindex)); ?>
										</td>
									</tr>
								</table>
							<?php echo form_close(); ?>
...
function check_payment_type()
{
	...
	else if($("#payment_types").val() == "<?php echo 'Card'; ?>" && cash_rounding)
	{
		$("#sale_total").html("<?php echo to_currency($cash_total); ?>");
		$("#sale_amount_due").html("<?php echo to_currency($cash_amount_due); ?>");
		$("#amount_tendered_label").html("<?php echo $this->lang->line('sales_amount_tendered'); ?>");
