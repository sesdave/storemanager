...
<?php echo form_open($controller_name . '/lab_categorysave/' . $test_info->lab_category_id, array('id'=>'item_form', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal')); ?>
	<fieldset id="item_basic_info">
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('lab_category_name'), 'test_code', array('class'=>'control-label col-xs-3')); ?>
			<div class='col-xs-8'>
				<div class="input-group">
					...
					<?php echo form_input(array(
							...
							'value'=>$test_info->lab_category_name)
							);?>
				</div>
			</div>
		</div>
