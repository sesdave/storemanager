...
<table class="sales_table_100" id="register" style="margin-top:0px; background-color:green">
			...
			<tr>
				...
				<th style="width: 30%;"></th>
						...
						<?php
							//print_r($item_inf);
							foreach($item_inf as $lin=>$item)
							{	?>
							<?php echo form_open($controller_name."/global_transfer/$lin", array('class'=>'form-horizontal', 'id'=>'cart_'.$lin,'class'=>'form-horizontal panel panel-default')); ?>
							<tr>
							<td><?php echo anchor($controller_name."/delete_item/$lin", '<span class="glyphicon glyphicon-trash"></span>');?></td>
							<td><?php echo $item['item_name']; ?><?php echo form_hidden('item_name', $item['item']); ?></td>
							<td style="align: center;">
								<?php echo $item['location_name']; ?><br /> <?php echo '[' . to_quantity_decimals($item['quantity']) . ' Available ' . ']';  ?>
								<?php echo form_hidden('transfer_location', $item['location_name']); ?>
								
							</td>

							
							<td><?php echo  form_input(array('name'=>'quantity', 'class'=>'form-control input-sm', 'value'=>'')); ?></td>
							<td></td>
							<td><a href="javascript:document.getElementById('<?php echo 'cart_'.$lin ?>').submit();" title=<?php echo $this->lang->line('sales_update')?> ><span class="glyphicon glyphicon-refresh"></span></a></td>
							
								<td></td>
							</tr>
						
						<?php
								//echo $ite['location_name'];
							}							
						?>
	...
	<table class="sales_table_100" id="register">
		...
		<tbody id="cart_contents">
			...
			?>
					...
					<?php
					if($item['in_stock'] <=0 and $mode != 'return'){?>
						...
						<div class="form-group form-group-sm">
							...
							<div class="col-xs-6">
								<label class="control-label checkbox" for="sales_invoice_enable">
									<?php echo form_checkbox(array('name'=>'sales_invoice_enable', 'id'=>'sales_invoice_enable', 'value'=>1, 'checked'=>true)); ?>
