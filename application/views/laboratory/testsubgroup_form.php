...
<?php echo form_open($controller_name . '/lab_testsubgroupsave/' . $test_info->lab_subgroup_id, array('id'=>'item_form', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal')); ?>
	<fieldset id="item_basic_info">
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('lab_subgroup_name'), 'test_code', array('class'=>'control-label col-xs-3')); ?>
			<div class='col-xs-8'>
				<div class="input-group">
					<span class="input-group-addon input-sm"><span class="glyphicon glyphicon-barcode"></span></span>
					<?php echo form_input(array(
							'name'=>'lab_subgroup_name',
							'id'=>'lab_subgroup_name',
							'class'=>'form-control input-sm',
							'value'=>$test_info->lab_subgroup_name)
							);?>
				</div>
			</div>
		</div>
