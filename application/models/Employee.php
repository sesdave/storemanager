...
class Employee extends Person
{
	...
	*/
	...
	public function saving_employee_update(&$person_data, &$employee_data, $employee_id = FALSE)
	{
		$success = FALSE;
	...
	*/
	...
	public function activate_employee($employee_ids)
	{
		$success = FALSE;
		...
		//Delete permissions
			...
			//delete from employee table
			$this->db->where_in('person_id', $employee_ids);
			$success = $this->db->update('employees', array('deleted' => 0));
