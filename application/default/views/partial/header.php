...
<body>
		...
		<div class="navbar navbar-default" role="navigation" style="margin-bottom: 0px;">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm" href="<?php echo site_url(); ?>">IPOS<span class="glyphicon glyphicon-th-list" style="height:20px; width:20px; color:white; margin-left:5px;" id="sidebarToggle" href="#"></span></a>

					
				</div>
					<div style="float:right; margin-top:5px">
					<?php echo form_open("sales/global_add", array('id'=>'global_add_item_form')) ?>
						<div class="input-group">
						<?php echo form_input(array('name'=>'global_item', 'id'=>'global_item', 'class'=>'form-control','placeholder'=>'Global Search', 'aria-label'=>'Search', 'aria-describedby' =>'basic-addon2', 'tabindex'=>++$tabindex)); ?>
	...
	<li class="nav-item active">
		<a class="nav-link" href="<?php echo site_url("$module->module_id");?>">
