p.DEFAULTS = {
            ...
            return this.options.customSort !== a.noop ? void this.options.customSort.apply(this, [this.options.sortName, this.options.sortOrder]) : void(-1 !== f && (this.options.sortStable && a.each(this.data, function(a, b) {
                ...
                var i = m(c, d, b.options.escape),
                    j = m(g, d, b.options.escape),
            ...
            for (var k = this.pageFrom - 1; k < this.pageTo; k++) {
                var l, n = i[k],
                    ...
                    r = {},
                    s = [];
                if (!(a.inArray(n, this.hiddenRows) > -1)) {
        ...
        }, p.prototype.getHiddenRows = function() {
            var b = this,
                c = this.getData(),
                d = [];
