...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 10, 2018 at 04:58 PM
...
('address', '18, Ahmadu Bello Way, Jos, Plateau State'),
('barcode_content', 'id'),
...
('client_id', '30a472d3-eae1-4a5b-b8d3-00b06ac30d16'),
('company', 'Tinna Pharmacy'),
('company_logo', ''),
('country_codes', 'ng'),
('currency_decimals', '2'),
('currency_symbol', '₦'),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=22319 ;
...
('items', 'items', NULL),
('items_stock', 'items', 1),
('items_WholeSale', 'items', 2),
('item_kits', 'item_kits', NULL),
('messages', 'messages', NULL),
('migrate', 'migrate', NULL),
('receivings', 'receivings', NULL),
('receivings_stock', 'receivings', 1),
('receivings_WholeSale', 'receivings', 2),
('reports', 'reports', NULL),
('reports_categories', 'reports', NULL),
('reports_customers', 'reports', NULL),
('reports_discounts', 'reports', NULL),
('reports_employees', 'reports', NULL),
('reports_expiry', 'reports', NULL),
